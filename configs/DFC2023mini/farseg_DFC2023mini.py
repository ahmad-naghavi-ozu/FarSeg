...
# Configuration for DFC2023mini dataset
config = {
    "model": {
        "type": "FarSeg",
        "params": {
    ...
    "data": {
        "train": {
            ...
            "params": {
                "image_dir": "/home/asfand/Ahmad/datasets/DFC2023mini/train/rgb",
                "mask_dir": "/home/asfand/Ahmad/datasets/DFC2023mini/train/sem",
        ...
        "test": {
            "type": "GenericSegmentationDataLoader",
            "params": {
                "image_dir": "/home/asfand/Ahmad/datasets/DFC2023mini/valid/rgb",
                "mask_dir": "/home/asfand/Ahmad/datasets/DFC2023mini/valid/sem",
                "dataset_name": "DFC2023mini",
                "num_classes": 2,
                "class_values": [0, 1],
                "patch_config": {
